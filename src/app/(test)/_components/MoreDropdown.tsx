...
import BurgerMenuIcon from "@/assets/icons/burgerMenu/BurgerMenuIcon";
    ...
    <DropdownMenu open={open}>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <BurgerMenuIcon />
          <div className="pl-4 hidden xl:block text-base font-normal">
            <span>Plus</span>
          </div>
        </Button>
      </DropdownMenuTrigger>
      ...
      >
        {!showModeToggle && (
          <>
            ...
            <DropdownMenuItem
              className="menuItem" /*onClick={() => signOut()}*/
            >
              <LogOut size={20} />
              <p>Log out</p>
            </DropdownMenuItem>
